...
export default function DonorStudentsView() {
  ...
  const { donorData, sponsoredStudentsData, schoolsData, loading, refreshDonorData, API_BASE_URL } = useDonor();
  ...
  const handleViewProgress = (student) => {
    ...
    fetchMarksheets(student.id || student.studentId, student.schoolId);
  };
